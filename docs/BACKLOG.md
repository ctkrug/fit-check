...
- [x] **Live quant readout for manual GPU + param count input** *(wow moment)*
...
- [x] **Replace placeholder byte math with real GGUF bits-per-parameter formula**
...
- [x] **Add AWQ bits-per-parameter formula alongside GGUF**
...
- [x] **Calibrate tokens/sec estimate with a correction factor**
...
- [x] **Curated GPU picker with search**
...
- [x] **Hugging Face model lookup by repo ID**
...
- [x] **Architecture-aware parameter count fallback**
...
- [x] **"How this is calculated" breakdown per bar**
...
- [x] **Designed empty and error states**
...
- [x] **Apply the blueprint design system across the UI**
...
- [x] **Responsive layout at 390 / 768 / 1440**
...
- [x] **Boot-sequence signature detail and favicon**
